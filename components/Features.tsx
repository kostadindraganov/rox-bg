...
const features: Feature[] = [
  {
    title: '30.9% Реална Месечна Доходност',
  ...
  {
    title: '100% On-Chain Прозрачност',
  ...
  {
    title: 'Модел на Растеж "Flywheel"',
  ...
  {
    title: 'Автоматизиран Маркет Мейкър',
